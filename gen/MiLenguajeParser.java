...
public class MiLenguajeParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, T__19=20, TKN_PERIOD=21, TKN_EQUALS=22, TKN_COMMA=23, 
		TKN_COLON=24, TKN_LEFT_BRAC=25, TKN_RIGHT_BRAC=26, TKN_LEFT_PAREN=27, 
		TKN_RIGHT_PAREN=28, TKN_PLUS=29, TKN_MINUS=30, TKN_TIMES=31, TKN_DIV=32, 
		TKN_DIFF=33, TKN_LESS=34, TKN_LEQ=35, TKN_GREATER=36, TKN_GEQ=37, TKN_NUMBER=38, 
		TKN_TEXT=39, TRUE=40, FALSE=41, ID=42;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, "TKN_PERIOD", "TKN_EQUALS", 
			"TKN_COMMA", "TKN_COLON", "TKN_LEFT_BRAC", "TKN_RIGHT_BRAC", "TKN_LEFT_PAREN", 
			"TKN_RIGHT_PAREN", "TKN_PLUS", "TKN_MINUS", "TKN_TIMES", "TKN_DIV", "TKN_DIFF", 
			"TKN_LESS", "TKN_LEQ", "TKN_GREATER", "TKN_GEQ", "TKN_NUMBER", "TKN_TEXT", 
			"TRUE", "FALSE", "ID"
		};
	}
