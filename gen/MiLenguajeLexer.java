...
public class MiLenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "AND", "OR", "TRUE", "FALSE", "TKN_PERIOD", "TKN_EQUALS", "TKN_COMMA", 
			"TKN_COLON", "TKN_LEFT_BRAC", "TKN_RIGHT_BRAC", "TKN_LEFT_PAREN", "TKN_RIGHT_PAREN", 
			"TKN_PLUS", "TKN_MINUS", "TKN_TIMES", "TKN_DIV", "TKN_DIFF", "TKN_LESS", 
			"TKN_LEQ", "TKN_GREATER", "TKN_GEQ", "TKN_NUMBER", "TKN_TEXT", "ID", 
			"WS"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 21:
			...
			break;
		case 34:
			TKN_DIFF_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void TKN_DIFF_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 4:
			setText("!=");
			break;
